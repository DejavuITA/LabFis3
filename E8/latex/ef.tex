...
Anche in questo caso abbiamo variato la frequenza del segnale nello stesso range preso in considerazione precedentemente.
...
%\footnote{Il valore di $C_2$ ottenuto con questo calcolo non è compatibile con quello utilizzato effettivamente.Infatti ci aspettavamo una frequenza di taglio di molto maggiore ai \SI{3}{\hertz} avendo utilizzato una $C_2$ circa 50 volte inferiore a quella stimata.}
.
