...
Utilizzando la breadboard come sostegno abbiamo realizzato il circuito riportato in Fig. \ref{fig:cc1}; sono stati utilizzati inoltre un transistor BC107B, un LED verde, una resistenza nominale da $\SI{1}{\kilo\ohm}$ ($R_C = \SI{999.1}{\ohm}$) e una decade di resistenze. La decade di resistenza è stata inizialmente settata a $\SI{100}{\kilo\ohm}$ ($R_B = \SI{99.902}{\kilo\ohm}$).
...
Partendo dal circuito montato nella sezione precedente, lo abbiamo modificato per ottenere il circuito mostrato in Fig. \ref{fig:cc2}.
La decade è stata settata a \SI{10}{\kilo\ohm} ($R_B = \SI{9.993}{\kilo\ohm}$), mentre la resistenza $R_C$ è rimasta la stessa del circuito precedente.
