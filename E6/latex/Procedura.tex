...
\center
	...
	\caption{In grigio possiamo apprezzare il segnale in uscita dal ponte di Graetz senza il condensatore mentre in rosso vediamo quello ai capi del carico quando si aggiunge il condensatore}
	\label{fig:ripple}
\end{figure}