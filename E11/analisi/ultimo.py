...
#V1_01 = data01[2:,1]
#V2_01 = data01[2:,2]
data02 = np.genfromtxt("../dati/scope_01_001.csv", delimiter=',')
t_02 = data02[2:,0]
V1_02 = data02[2:,1]
V2_02 = data02[2:,2]
data03 = np.genfromtxt("../dati/scope_01_002.csv", delimiter=',')
t_03 = data03[2:,0]
V1_03 = data03[2:,1]
V2_03 = data03[2:,2]
data04 = np.genfromtxt("../dati/scope_03_001.csv", delimiter=',')
t_04 = data04[2:,0]
V1_04 = data04[2:,1]
V2_04 = data04[2:,2]
...
# Titolo del grafico
f1.suptitle("Amplificatori invertente e non invertente", y=0.98, fontsize=17)
...
# GRAFICO 2
ax2 = host_subplot(131, axes_class=AA.Axes)
...
ax2.set_ylim((-14.5, 14.5))

ax2.text(-1.2, 0, u'd.d.p. [$V$]', va='center', ha='right', rotation='vertical', fontsize=16)

ax2.grid(True)

# GRAFICO 3
ax3 = host_subplot(132, axes_class=AA.Axes)
...
ax3.set_ylim((-14.5, 14.5))

ax3.text(0, -16.0, u'tempo [$ms$]', va='top', ha='center', fontsize=16)
...
ax4.set_ylim((-14.5, 14.5))

ax4.grid(True)

# questo imposta i bordi del grafico
f1.subplots_adjust(left=0.035, right=0.99,
    top=0.94, bottom=0.10, hspace=0.075, wspace=0.08)
